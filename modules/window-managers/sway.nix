...
in {
  ...
  home-manager.users.alternateved.wayland.windowManager.sway =
    let wall = "cat ~/.cache/wall";
    in {
      enable = true;
      xwayland = true;
      ...
      config = rec {
        ...
        assigns = {
          "1" = [{ class = "Firefox"; }];
          "2" = [ { title = "Discord"; } { class = "Signal"; } ];
          "5" = [ { class = "mpv"; } { class = "Spotify"; } ];
        };
        ...
        keybindings = {
          ...
          "${modifier}+Control+Left" = "resize grow width 20 px";
          "${modifier}+Control+Down" = "resize shrink height 20 px";
          "${modifier}+Control+Up" = "resize grow height 20 px";
          "${modifier}+Control+Right" = "resize shrink width 20 px";
          ...
          "${modifier}+F2" =
            "exec bash ~/.nixos-config/config/scripts/websearch";
          "${modifier}+F3" =
