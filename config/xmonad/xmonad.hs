...
myFont :: String
myFont = "xft:Rec Mono Casual:style=regular:size=11:antialias=true:hinting=true"
...
myKeys =
  ...
  [ ("M-S-r", spawn "xmonad --restart"),
    ...
    ("M-l e", sendMessage $ JumpToLayout "englare"),
    ("M-l c", sendMessage $ JumpToLayout "columns"),
    ("M-l g", sendMessage $ JumpToLayout "grid"),
    ("M-l m", sendMessage $ JumpToLayout "monocle"),
